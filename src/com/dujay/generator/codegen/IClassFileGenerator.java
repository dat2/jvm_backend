...
public interface IClassFileGenerator {
  ...
  default public void constMemberRef(int memberType, int classIdx, int nameTypeIdx) {
    u1(memberType);
    u2(classIdx);
    u2(nameTypeIdx);
  }
  ...
  default public void constInvokeDynamic(int bootstrapMethodIdx, int nameAndTypeIdx) {
